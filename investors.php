        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <section aria-labelledby="investor-contact-heading">
                    <h4 id="investor-contact-heading" class="text-3xl  text-gray-900 mb-6">Investor Contact</h4>
                ...
                <section aria-labelledby="disclosure-heading">
                    <h4 id="disclosure-heading" class="text-3xl text-red-600 mb-6">Disclosure Under Regulation 46 of SEBI LODR</h4>
