...
<body class="bg-color2">
    ...
    <div class="container mx-auto px-4 py-16">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <!-- Card 1 -->
            <div class="bg-white rounded-3xl shadow-md border border-gray-100 hover:shadow-2xl transition-all duration-300 group">
                <div class="overflow-hidden rounded-t-3xl">
                    <img src="assets/img/c1.png" alt="Research Lab"
                        class="w-full h-64 object-cover transition-transform duration-500 group-hover:scale-105">
                </div>
                <div class="p-6 flex flex-col gap-4">
                    <div class="flex items-center gap-3">
                        <i class="fa-solid fa-book-open-reader text-red-500 text-3xl"></i>
                        <h3 class="text-xl font-semibold text-gray-800 group-hover:text-red-500 transition duration-300">
            ...
            <div class="bg-white rounded-3xl shadow-md border border-gray-100 hover:shadow-2xl transition-all duration-300 group">
                <div class="overflow-hidden rounded-t-3xl">
                    <img src="assets/img/c2.png" alt="Support Ecosystem"
                        class="w-full h-64 object-cover transition-transform duration-500 group-hover:scale-105">
                </div>
                <div class="p-6 flex flex-col gap-4">
                    <div class="flex items-center gap-3">
                        <i class="fa-solid fa-question text-red-500 text-3xl"></i>
                        <h3 class="text-xl font-semibold text-gray-800 group-hover:text-red-500 transition duration-300">
                            Support EcoSystem
                        </h3>
                    </div>
            ...
            <div class="bg-white rounded-3xl shadow-md border border-gray-100 hover:shadow-2xl transition-all duration-300 group">
                <div class="overflow-hidden rounded-t-3xl">
                    <img src="assets/img/c3.png" alt="Customization Track Record"
                        class="w-full h-64 object-cover transition-transform duration-500 group-hover:scale-105">
                </div>
                <div class="p-6 flex flex-col gap-4">
                    <div class="flex items-center gap-3">
                        <i class="fa-solid fa-notes-medical text-red-500 text-3xl"></i>
                        <h3 class="text-xl font-semibold text-gray-800 group-hover:text-red-500 transition duration-300">
                            Customization Track Record
                        </h3>
                    </div>
                    <p class="text-gray-600 text-sm leading-relaxed">
